        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    meal_date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    activity_level = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    bmi = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    bmr = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    daily_calorie_need = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_physical_info", x => x.id);
                    table.ForeignKey(
                        name: "FK_physical_info_Users_user_id",
                        column: x => x.user_id,
                        principalTable: "Users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_search_history_foods_food_id",
                        column: x => x.food_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_physical_info_user_id",
                table: "physical_info",
                column: "user_id");

            migrationBuilder.CreateIndex(
                name: "IX_search_history_food_id",
